...
| <a name="input_enable_container_insights"></a> [enable\_container\_insights](#input\_enable\_container\_insights) | Enable/disable container insights for the ECS cluster | `bool` | `true` | no |
