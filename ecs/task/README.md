...
| <a name="input_placement_constraints_expression"></a> [placement\_constraints\_expression](#input\_placement\_constraints\_expression) | Placement constraints for the task in Cluster Query Language | `string` | `null` | no |
